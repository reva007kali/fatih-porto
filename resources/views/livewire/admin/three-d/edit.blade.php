        ...
        <div class="bg-white dark:bg-zinc-900 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold">Edit 3D Model</h2>
                ...
                <form wire:submit.prevent="update" class="space-y-6">
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Replace 3D Model File (Optional)</label>
                        <input type="file" wire:model="model_file" accept=".glb,.gltf" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-zinc-800 dark:border-zinc-700 dark:placeholder-gray-400">
                        <div class="mt-1 text-xs text-gray-500">Current file: {{ basename($model->model_path) }}</div>
                    ...
                    <div>
                        ...
                        @elseif($model->thumbnail_path)
                            <div class="mt-2">
                                <img src="{{ Storage::url($model->thumbnail_path) }}" class="h-32 rounded-lg object-cover">
                            </div>
                        @endif
