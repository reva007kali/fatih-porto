<div class="min-h-screen py-6 bg-[#0b0b0d]">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-400 mt-2">Upload a new track and cover art.</p>
        </div>
                ...
                <form wire:submit.prevent="store" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-2">MP3, WAV, OGG, M4A up to 20MB.</p>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Optional. JPG, PNG up to 2MB.</p>
