                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2">
                            <label for="description"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Description</label>
                        ...
                        <div class="col-span-1 md:col-span-2" wire:ignore>
                            <label for="content"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Case Study
                                Details</label>
                            <div x-data="{
                        ...
                        <div>
                            <label for="category"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Category</label>
                        ...
                        <div>
                            <label for="role"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Role</label>
                        ...
                        <div>
                            <label for="year"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Year</label>
                        ...
                        <div>
                            <label for="client"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Client</label>
                        ...
                        <div>
                            <label for="link"
                                class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Link</label>
                            ...
                            <div class="flex flex-col gap-3 p-4 bg-[#0b0b0d] rounded-xl border border-white/5">
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" wire:model="is_featured"
                                        class="form-checkbox h-4 w-4 text-swiss-blue rounded border-gray-600 bg-[#1c1c1e] focus:ring-swiss-blue">
                                    <span class="ml-2 text-sm text-gray-300">Feature on Homepage</span>
                                </label>
                                <label class="flex items-center cursor-pointer">
                                    <input type="checkbox" wire:model="is_archived"
                                        class="form-checkbox h-4 w-4 text-red-500 rounded border-gray-600 bg-[#1c1c1e] focus:ring-red-500">
                        ...
                        <div class="col-span-1 md:col-span-2 border-t border-white/5 pt-4">
                            <label class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-4">Project
                                Cover Image</label>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                @if ($cover_image)
                                    <div>
                                        <p class="text-[10px] text-gray-500 uppercase font-bold mb-2">Current Cover</p>
                                        @php
                                        ...
                                        @endphp
                                        @if ($isVideo)
                                            <video src="{{ asset('storage/' . $cover_image) }}"
                                ...
                                @if ($coverImage)
                                    <div>
                                        <p class="text-[10px] text-blue-500 uppercase font-bold mb-2">New Cover Preview
                                        </p>
                                        @if (Str::startsWith($coverImage->getMimeType(), 'video'))
                                            <video src="{{ $coverImage->temporaryUrl() }}"
                                                class="w-full h-48 object-cover rounded-xl border border-blue-500/30"
                                                controls></video>
                                        @else
                            ...
                            <label
                                class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-white/10 rounded-xl cursor-pointer hover:bg-white/5 hover:border-swiss-blue/50 transition-all">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-sm text-gray-500">Change Cover (Image/Video)</p>
                                </div>
                                <input type="file" wire:model="coverImage" class="hidden"
                                    accept="image/*,video/*" />
                            </label>
                            <div wire:loading wire:target="coverImage" class="text-xs text-swiss-blue mt-2 font-bold">
                                Uploading Cover...</div>
                            <x-input-error class="mt-2 text-xs text-red-500" :messages="$errors->get('coverImage')" />
                        </div>
                        ...
                        <div class="col-span-1 md:col-span-2 border-t border-white/5 pt-4">
                                    ...
                                    @foreach ($existingMedia as $media)
                                        <div
                                            ...
                                            @if ($media->file_type === 'video')
                                                ...
                                                <div
                                                    class="absolute top-1 left-1 bg-black/50 text-[10px] text-white px-1.5 rounded">
                                                    Video</div>
                                            @else
                            ...
                            <label
                                ...
                                <input type="file" wire:model="mediaFiles" multiple class="hidden"
                                    accept="image/*,video/*" />
                            </label>
                            <div wire:loading wire:target="mediaFiles" class="text-xs text-swiss-blue mt-2 font-bold">
                                Uploading...</div>
                                ...
                                <div class="mt-6 space-y-3">
                                    ...
                                    @foreach ($mediaFiles as $index => $file)
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 rounded border border-white/10 overflow-hidden flex-shrink-0">
                                                @if (Str::startsWith($file->getMimeType(), 'video'))
                                                    <div
                                                        class="w-full h-full bg-gray-800 flex items-center justify-center text-[10px] text-gray-400">
                                                        Vid</div>
                                                @else
                                            ...
                                            <input wire:model="captions.{{ $index }}" type="text"
                                                placeholder="Caption..."
