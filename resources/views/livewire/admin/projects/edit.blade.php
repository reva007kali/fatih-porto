                ...
                <form wire:submit.prevent="update" class="space-y-6" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1 md:col-span-2 border-t border-white/5 pt-4">
                            <label class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-4">Project Cover Image</label>
                            
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                                @if ($cover_image)
                                    <div>
                                        <p class="text-[10px] text-gray-500 uppercase font-bold mb-2">Current Cover</p>
                                        <img src="{{ asset('storage/' . $cover_image) }}" class="w-full h-48 object-cover rounded-xl border border-white/10">
                                    </div>
                                @endif

                                @if ($coverImage)
                                    <div>
                                        <p class="text-[10px] text-blue-500 uppercase font-bold mb-2">New Cover Preview</p>
                                        <img src="{{ $coverImage->temporaryUrl() }}" class="w-full h-48 object-cover rounded-xl border border-blue-500/30">
                                    </div>
                                @endif
                            </div>
                            ...
                            <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-white/10 rounded-xl cursor-pointer hover:bg-white/5 hover:border-swiss-blue/50 transition-all">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-sm text-gray-500">Change Cover Image</p>
                                </div>
                                <input type="file" wire:model="coverImage" class="hidden" accept="image/*" />
                            </label>
                            <div wire:loading wire:target="coverImage" class="text-xs text-swiss-blue mt-2 font-bold">Uploading Cover...</div>
