                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label for="about_text" class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Tagline / About Text</label>
                            ...
                            <div>
                                <label for="availability_text" class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Availability Text</label>
                    ...
                    {{-- Bottom Bar --}}
                     <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="watermark_text" class="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Large Watermark Text</label>
